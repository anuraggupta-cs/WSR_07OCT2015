...
public class DataSupply extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("HI From data supply manager");
	    ...
	    System.out.println("In data supply : App name : "+app+"  sdate  : "+sdate+" edate : "+edate+" type of chart  : "+typeOfChart+" type of report :"+typeofReport );
