...
public class Services {
	...
	public Map<String, ResultSet> getData(String track, String sdate,
		...
		m = new HashMap<String, ResultSet>();
		...
		/*
		 *  
		 *  m.put("Priority Monthly",
		 * getResultSetForMonthlyPriorityReport(track, sdate, edate));
		 * m.put("Priority Weekly", getResultSetForWeeklyPriorityReport(track,
		 * sdate, edate));
		 * 
		 * m.put("Status", getResultSetForStatusReport(track, sdate, edate));
		 * m.put("Status Monthly", getResultSetForMonthlyStatusReport(track,
		 * sdate, edate)); m.put("Status Weekly",
		 * getResultSetForWeeklyStatusReport(track, sdate, edate));
		 */
